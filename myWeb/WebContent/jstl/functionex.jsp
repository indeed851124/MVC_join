...
substring(str1, 3, 6) = "${fn:substring(str1,3,6) }" <br></br> <!-- 3~5까지 자르기 -->
substringAfter(str1, str2) = "${fn:substringAfter(str1,str2) }" <br></br>
substringBefore(str1, str2) = "${fn:substringBefore(str1,str2) }" <br></br>
trim(str1) = "${fn:trim(str1) }"<br></br> <!-- 좌우 공백문자 제거 -->
replace(str1,src,dest) = "${fn:replace(str1, " ", "-")}"<br></br>
indexOf(str1,str2) = "${fn:indexOf(str1,str2) }"<br></br> <!-- str2가 str1의 어느 인덱스에 있는지  -->
